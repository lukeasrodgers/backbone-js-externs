...
cmd << " --externs backbone-1.0.0-externs.js "
cmd << " --js test/1.0.0/collection.js"
cmd << " --js test/1.0.0/events.js"
cmd << " --js test/1.0.0/model.js"
cmd << " --js test/1.0.0/router.js"
cmd << " --js test/1.0.0/sync.js"
cmd << " --js test/1.0.0/view.js"
`#{cmd}`
